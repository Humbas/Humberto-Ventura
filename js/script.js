...
Humberto Ventura | Visual Designer - 2017
=====================================================================================
  ...
  $.fn.SceneHome = function() {	   
	  this.each(function() { 	      
	        ...
	        function on_scroll(e,distance) {
	        	...
	        	//var mainpos = '50% ' + (-5+$.Window.height()/2-distance*.15) + 'px'; // background
	        	var bpos1 = '50% ' + (-405+$.Window.height()/2-distance*.15) + 'px';
	        	var bpos2 = (-106+distance/12) + '% ' + (1330+$.Window.height()/2-distance*1) + 'px'; //
	        	var bpos4 = (-106+distance/12) + '% ' + (1330+$.Window.height()/2-distance*1) + 'px'; //
		        var bpos9 = (10+distance/12) + '% ' + (1170+$.Window.height()/2-distance*1) + 'px'; //
		      	var bpos5 = (200-distance/10) + '% ' + (200+$.Window.height()/2-distance*.15) + 'px'; // 
	            var bpos6 = (-110+distance/10) + '% ' + (30+$.Window.height()/3-distance*.10) + 'px';  
	            var bpos7 = (-44+distance/20) + '% ' + (415+$.Window.height()/2-distance/8) + 'px'; 		          
  ...
  $.fn.ScenePedi = function() {	   
	  this.each(function() { 	      
	        ...
	        function on_scroll(e,distance) {
	          ...
	          var mainpos = '50% ' + (-420+$.Window.height()/2-distance*.15) + 'px';
		      var bpos1 = '50% ' + (-490+$.Window.height()/2+distance/3) + 'px';
		      var bpos2 = '50% ' + (15+$.Window.height()/2-distance*.15) + 'px'; 
	          var bpos3 = '50% ' + (-150+$.Window.height()/2-distance*.1) + 'px';
	          var bpos4 = '50% ' + (-160+$.Window.height()/2-distance*.125) + 'px'; 
	          var bpos5 = '50% ' + (-120+$.Window.height()/2-distance*.1) + 'px'; 
	          var bpos6 = '50% ' + (-220+$.Window.height()/2+distance/4) + 'px'; // bird
	          var bpos7 = (-20+distance/20) + '% ' + (-45+$.Window.height()/2-distance/8) + 'px';  
	          var bpos8 = (-20+distance/20) + '% ' + (5+$.Window.height()/2-distance/8) + 'px'; 
	          var bpos9 = '50% ' + (255+$.Window.height()/2-distance*.1) + 'px'; 
	          var bpos10 = '50% ' + (255+$.Window.height()/2-distance*.1) + 'px'; 
  ...
  $.fn.SceneSpokes = function() {	   
	  this.each(function() { 	      
	        ...
	        function on_scroll(e,distance) {
	          ...
	          var mainpos = '50% ' + (-400+$.Window.height()/2-distance*.15) + 'px';
	          var bpos1 = (190-distance/15) + '% ' + (360+$.Window.height()/2-distance*.25) + 'px'; 
	          var bpos2 = (175-distance/21) + '% ' + (140+$.Window.height()/2-distance*.25) + 'px';
	          var bpos3 = (180-distance/18) + '% ' + (180+$.Window.height()/2-distance*.25) + 'px';
	          var bpos4 = (-20+distance/25) + '% ' + (220+$.Window.height()/2-distance*.15) + 'px'; 
	          var bpos5 = (-60+distance/20) + '% ' + (220+$.Window.height()/2-distance*.15) + 'px'; 
	          var bpos6 = (-10+distance/40) + '% ' + (-110+$.Window.height()/2-distance*.155) + 'px'; 
	          var bpos7 = (-5+distance/45) + '% ' + (-120+$.Window.height()/2-distance*.135) + 'px';
	          var bpos8 = (-15+distance/35) + '% ' + (-60+$.Window.height()/2-distance*.175) + 'px';
